...
TEST(TestParser, ParseLiteral)
{
    ...
    for (const auto& [input, expected] : testCases) {
        ...
        EXPECT_EQ(actual->kind(), expected->kind())
            << "类型不匹配: " << input << ", 实际类型: " << int(actual->kind())
...
TEST(TestParser, ParseExpression)
{
    ...
    testCases.emplace_back("5 * 2",
        std::make_unique<BinaryExpression>(Operator::Multiply, std::make_unique<IntegerLiteral>(5),
            std::make_unique<IntegerLiteral>(2)));
    testCases.emplace_back("10 / 2",
        std::make_unique<BinaryExpression>(Operator::Divide, std::make_unique<IntegerLiteral>(10),
            std::make_unique<IntegerLiteral>(2)));
    testCases.emplace_back("4 - 1",
        std::make_unique<BinaryExpression>(Operator::Subtract, std::make_unique<IntegerLiteral>(4),
    ...
    testCases.emplace_back("3 + (4 * 2)",
        std::make_unique<BinaryExpression>(Operator::Add, std::make_unique<IntegerLiteral>(3),
            std::make_unique<BinaryExpression>(Operator::Multiply,
                std::make_unique<IntegerLiteral>(4), std::make_unique<IntegerLiteral>(2))));

    std::vector<std::unique_ptr<Expression>> args;
    args.push_back(std::make_unique<IntegerLiteral>(1));
    args.push_back(std::make_unique<IntegerLiteral>(2));
    testCases.emplace_back("a(1, 2)",
        std::make_unique<CallExpression>(
            std::make_unique<VariableExpression>("a"), std::move(args)));
...
TEST(TestParser, ParseStatement)
{
    ...
    testCases.emplace_back(
        "return 10;", std::make_unique<ReturnStatement>(std::make_unique<IntegerLiteral>(10)));

    testCases.emplace_back("let a;", std::make_unique<LetStatement>(std::string("a"), nullptr));

    testCases.emplace_back("let a = 1;",
        std::make_unique<LetStatement>(std::string("a"), std::make_unique<IntegerLiteral>(1)));
    ...
    // if-then-else
    {
        std::vector<std::unique_ptr<Statement>> thenStmts;
        thenStmts.push_back(
            std::make_unique<ExpressionStatement>(std::make_unique<IntegerLiteral>(1)));
        std::vector<std::unique_ptr<Statement>> elseStmts;
        elseStmts.push_back(
            std::make_unique<ExpressionStatement>(std::make_unique<IntegerLiteral>(2)));
    ...
    // empty for statement
    {
        ...
        testCases.emplace_back("for ; ; { }",
            std::make_unique<ForStatement>(nullptr, nullptr, nullptr,
    ...
    // for statement
    {
        ...
        testCases.emplace_back("for let i = 0; i < 10; i = i + 1 { 1; }",
            std::make_unique<ForStatement>(std::make_unique<LetStatement>(std::string("i"),
                                               std::make_unique<IntegerLiteral>(0)),
                std::make_unique<BinaryExpression>(Operator::LessThan,
                    std::make_unique<VariableExpression>("i"),
                    std::make_unique<IntegerLiteral>(10)),
                std::make_unique<BinaryExpression>(Operator::Assign,
                    std::make_unique<VariableExpression>("i"),
                    std::make_unique<BinaryExpression>(Operator::Add,
                        std::make_unique<VariableExpression>("i"),
                        std::make_unique<IntegerLiteral>(1))),
    ...
    testCases.emplace_back("3 * 4;",
        std::make_unique<ExpressionStatement>(std::make_unique<BinaryExpression>(Operator::Multiply,
            std::make_unique<IntegerLiteral>(3), std::make_unique<IntegerLiteral>(4))));

    // block statement
    {
        std::vector<std::unique_ptr<Statement>> blockStmts;
        blockStmts.push_back(
            std::make_unique<LetStatement>("x", std::make_unique<IntegerLiteral>(5)));
        blockStmts.push_back(
            std::make_unique<ReturnStatement>(std::make_unique<VariableExpression>("x")));
        testCases.emplace_back(
            "{ let x =5; return x; }", std::make_unique<BlockStatement>(std::move(blockStmts)));
    }
    ...
    // fn statement
    {
        ...
        blockStmts.push_back(std::make_unique<ReturnStatement>(std::make_unique<BinaryExpression>(
            Operator::Add, std::make_unique<VariableExpression>("x"),
        ...
        testCases.emplace_back("fn add(x, y) { return x + y; }",
            std::make_unique<FnStatement>(
                std::move(std::string("add")), std::move(params), std::move(body)));
    }
